...
// MockGitHubAPI is an autogenerated mock type for the githubAPI type
type MockGitHubAPI struct {
	mock.Mock
}

// GetLatestRelease provides a mock function with given fields: ctx, owner, repo
func (_m *MockGitHubAPI) GetLatestRelease(ctx context.Context, owner string, repo string) (*github.RepositoryRelease, *github.Response, error) {
